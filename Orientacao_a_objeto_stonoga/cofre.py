...
# Gostaria de resgatar meu instrumento que foi roubado e aprisionado em um cofre...
# um codigo deve ser criado a partir das seguintes informações:
# Sabemos apenas que são três numeros distintos cuja a soma dá exatamente 100. Além disso, os três devem estar em ordem decrescente.
